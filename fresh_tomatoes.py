...
"""
funtion: create_movie_tiles_content(movies)
...
"""
funtion: open_movies_page(movies):(movies)
description: creates and opens fresh tomatoes web page
input: list of class Movie
output: None
"""
